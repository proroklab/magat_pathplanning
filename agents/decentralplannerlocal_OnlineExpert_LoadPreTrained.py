'''
Loading pre-trained paramters from models trained by decentralplannerlocal_OnlineExpert.py
Warnings: As fine-tuning models were not used in our paper, these are only concept-proof codes.
        ...
        For any formal use, please sync this file with decentralplannerlocal_OnlineExpert.py
        and debug.
'''
...
class DecentralPlannerAgentLocalWithOnlineExpertLoadOE(BaseAgent):
    ...
    def __init__(self, config):
        ...
        if not self.config.batch_numAgent:
            ...
            # from graphs.models.decentralplanner_GSO1 import DecentralPlannerNet
            # from graphs.models.decentralplanner_noCompress import DecentralPlannerNet
        ...
        if self.config.train_TL or self.config.test_general:
            ...
            self.load_pretrained_checkpoint_for_Attention(self.config.test_epoch, lastest=self.config.lastest_epoch, best=self.config.best_epoch)
