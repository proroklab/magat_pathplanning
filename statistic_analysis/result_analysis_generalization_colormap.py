                        ...
                        if metrics == 'rate_ReachGoal':
                            ...
                            for id_case, status_reach_goal in enumerate(searched_results[0]["list_reachGoal"]):
                                ...
                                if status_reach_goal:
                                    ...
                                    value_predict = searched_results[0]['list_FT_predict'][id_case]
                                    value_target = searched_results[0]['list_FT_target'][id_case]
                                    value_div_FT = np.divide(np.subtract(value_predict,value_target),value_target)
                                    print("add data -", load_data[id_case], value_div_FT)
                                    list_div_FT.append(value_div_FT)

                            div_FT = np.array(list_div_FT)
                            label_data_text.append(np.around(np.mean(div_FT), decimals=4))
                        #########################
                        ##### Save data as string
                        #########################
...
if __name__ == '__main__':
    ...
    DATA_FOLDER = '../MultiAgentDataset/Results_best/Statistics_generalization/'
    epoch_text = "IROS"
