...
def return_config(title, id=0):
    ...
    #         'K': 2,
    #     },
    #     'label': 'GNN_OE_F32_SkipMLPGNN_NODATA',
    #     'color': 'orange red',
    #     'dash': (4, 3),
    # },
    # '1601108329': {
    ...
    #         'K': 2,
    #     },
    #     'label': 'GNN_OE_F16_SkipMLPGNN_RESELECT',
    #     'color': 'pinky purple',
    #     'dash': (4, 3),
    # },
    # '1601694357': {
    ...
    #         'K': 2,
    #     },
    #     'label': 'GAT_OE_F16_SkipMLPGNN_DOWN',
    #     'color': 'cobalt blue',
    #     'dash': (4, 3),
    # },
...
class StatisticAnalysis:
    ...
    def print_analysis_large_set(self,config):
        ...
        ax.legend(handles=handles[0:], labels=labels[0:], loc='lower left', fontsize=18, ncol=1, borderaxespad=0.1, handleheight=0.1, columnspacing=0.2,
                  labelspacing=0.05)
